...
('Gama Media', 'El estándar de la industria. Ideal para jugar a 1080p y tareas de desarrollo.'),
...
(2, 6.12, '2026-05-01'), -- RTX 3060 (Una de las más usadas)
...
(3, 2, 670000),   -- CASO PRECIO ALTO: En eBay está a 560k, nosotros a 670k (Poco competitivos)
(7, 12, 140000),
...
-- 7. Insertar Catálogo de Videojuegos (Kaggle)
...
(1, 2, 'Recommended'), -- Cyberpunk pide mínimo/recomendado una RTX 3060
...
('PC Gamer Entrada Economico', 'Configuración balanceada ideal para estudiantes y juegos competitivos livianos.'),
('PC Gamer Ultra 1080p', 'Diseñado para romper cualquier juego actual en calidad Ultra a más de 60 FPS.'),
('PC Streamer Enthusiast 4K', 'Estación de trabajo pesada y juegos AAA en máxima resolución.');
...
(1, 1),  -- Build Económica usa la GTX 1650
(1, 5),  -- Usa el i3
(1, 9),  -- Usa 8GB de RAM
